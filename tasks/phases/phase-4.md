...
- [x] Step 4.9: Refactor the compatibility and diagnostics boundary if needed while keeping the new tests green.
...
**Acceptance Criteria:**
- [x] Compatibility mode can analyze a representative existing Swift codebase fixture.
- [x] Unsupported Apple-only APIs produce structured diagnostics instead of crashes.
- [x] Supported subset examples lower into the strict runtime model.
- [x] The compatibility matrix documents supported, partially supported, unsupported, and deferred areas.
- [x] All phase tests pass.
- [x] No regressions in previous phase tests.

**On Completion:**
- Deviations from plan: Step 4.9 found no need for a broader diagnostics/runtime boundary refactor; the only justified cleanup was deriving compatibility lowering previews from the actual lowered runtime tree to prevent drift.
- Tech debt / follow-ups: broader SwiftUI compatibility remains intentionally deferred to future migration/reporting work.
